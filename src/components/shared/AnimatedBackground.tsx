...
function AnimatedBackground({ children }: { children?: ReactNode }) {
    return (
        <div className="flex w-full px-10 pt-10 relative  overflow-hidden">
            <div className="flex fixed right-10 left-10 z-40 max-w-[1460px] mx-auto">{children}</div>
            <div className="relative z-30 ml-auto right-0 overflow-visible max-w-[1000px]">
